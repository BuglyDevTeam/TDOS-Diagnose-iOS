...
//////////////////////////////////////
NS_INLINE BOOL rfkt_flex_isTaggedPointer(const void *ptr)  {
    #if OBJC_HAVE_TAGGED_POINTERS
...
#define RFKT_FLEXPointerIsTaggedPointer(obj) rfkt_flex_isTaggedPointer((__bridge void *)obj)

BOOL RFKT_FLEXPointerIsReadable(const void * ptr);
...
/// https://blog.timac.org/2016/1124-testing-if-an-arbitrary-pointer-is-a-valid-objective-c-object/
BOOL RFKT_FLEXPointerIsValidObjcObject(const void * ptr);
