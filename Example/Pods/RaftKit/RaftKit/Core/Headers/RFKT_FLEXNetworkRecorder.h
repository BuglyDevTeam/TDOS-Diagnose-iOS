//
//  RFKT_FLEXNetworkRecorder.h
//  Flipboard
//
//  Created by Ryan Olson on 2/4/15.
//  Copyright (c) 2020 RFKT_FLEX Team. All rights reserved.
//

#import <Foundation/Foundation.h>

// Notifications posted when the record is updated
extern NSString *const kRFKT_FLEXNetworkRecorderNewTransactionNotification;
extern NSString *const kRFKT_FLEXNetworkRecorderTransactionUpdatedNotification;
extern NSString *const kRFKT_FLEXNetworkRecorderUserInfoTransactionKey;
extern NSString *const kRFKT_FLEXNetworkRecorderTransactionsClearedNotification;

@class RFKT_FLEXNetworkTransaction;

@interface RFKT_FLEXNetworkRecorder : NSObject

/// In general, it only makes sense to have one recorder for the entire application.
@property (nonatomic, readonly, class) RFKT_FLEXNetworkRecorder *defaultRecorder;
...
/// Array of RFKT_FLEXNetworkTransaction objects ordered by start time with the newest first.
- (NSArray<RFKT_FLEXNetworkTransaction *> *)networkTransactions;

/// The full response data IFF it hasn't been purged due to memory pressure.
- (NSData *)cachedResponseBodyForTransaction:(RFKT_FLEXNetworkTransaction *)transaction;
