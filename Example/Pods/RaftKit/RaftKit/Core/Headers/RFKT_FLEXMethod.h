...
/// always go back and move it to \c RFKT_FLEXMethodBase if we find we need to.
@interface RFKT_FLEXMethod : RFKT_FLEXMethodBase
...
/// Constructs an \c RFKT_FLEXMethod for the given method on the given class.
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c RFKT_FLEXMethod object, or \c nil if the
...
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c RFKT_FLEXMethod object, or \c nil \e if the
...
- (void)swapImplementations:(RFKT_FLEXMethod *)method;

#define RFKT_FLEXMagicNumber 0xdeadbeef
#define RFKT_FLEXArg(expr) RFKT_FLEXMagicNumber,/// @encode(__typeof__(expr)), (__typeof__(expr) []){ expr }
...
@interface RFKT_FLEXMethod (Comparison)

- (NSComparisonResult)compare:(RFKT_FLEXMethod *)method;
