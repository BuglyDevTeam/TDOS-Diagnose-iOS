...
/**
 * `RFKTLabel`支持通过`contentEdgeInsets`属性来实现类似padding的效果。
 *
 ...
 */
@interface RFKTLabel : UILabel

/// 控制label内容的padding，默认为UIEdgeInsetsZero
@property(nonatomic,assign) UIEdgeInsets contentEdgeInsets;

/// 修改intrinsicContentSize，用于StackView布局
@property (nonatomic,assign) CGSize designedSize;

/// 是否需要支持点击，默认为 NO。
/// 点击时的背景色通过`highlightedBackgroundColor`设置。
@property(nonatomic,assign) BOOL canClick;

/// 是否需要点击复制的功能，默认为 NO。
/// 点击时的背景色通过`highlightedBackgroundColor`设置。
@property(nonatomic,assign) BOOL shouldPerformCopyActionWhenClick;
...
/// 新增：点击后的回调
@property(nonatomic, copy) void (^didClickBlock)(RFKTLabel *label);

/// 点击了“复制”后的回调
@property(nonatomic, copy) void (^didCopyBlock)(RFKTLabel *label, NSString *stringCopied);
