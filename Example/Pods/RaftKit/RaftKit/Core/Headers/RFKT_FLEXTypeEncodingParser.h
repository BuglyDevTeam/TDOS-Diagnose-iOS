...
BOOL RFKT_FLEXGetSizeAndAlignment(const char *type, NSUInteger * _Nullable sizep, NSUInteger * _Nullable alignp);

@interface RFKT_FLEXTypeEncodingParser : NSObject
