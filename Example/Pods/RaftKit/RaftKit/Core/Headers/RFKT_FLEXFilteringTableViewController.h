...
#pragma mark - RFKT_FLEXTableViewFiltering
@protocol RFKT_FLEXTableViewFiltering <RFKT_FLEXSearchResultsUpdating>
...
@property (nonatomic, copy) NSArray<RFKT_FLEXTableViewSection *> *sections;
...
@property (nonatomic, copy) NSArray<RFKT_FLEXTableViewSection *> *allSections;

/// This computed property should filter \c allSections for assignment to \c sections
@property (nonatomic, readonly, copy) NSArray<RFKT_FLEXTableViewSection *> *nonemptySections;

/// This should be able to re-initialize \c allSections
- (NSArray<RFKT_FLEXTableViewSection *> *)makeSections;

@end


#pragma mark - RFKT_FLEXFilteringTableViewController
/// A table view which implements \c UITableView* methods using arrays of
/// \c RFKT_FLEXTableViewSection objects provied by a special delegate.
@interface RFKT_FLEXFilteringTableViewController : RFKT_FLEXTableViewController <RFKT_FLEXTableViewFiltering>
...
@property (nonatomic, weak) id<RFKT_FLEXTableViewFiltering> filterDelegate;
