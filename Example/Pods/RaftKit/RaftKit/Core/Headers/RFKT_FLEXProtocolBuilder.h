...
@class RFKT_FLEXProperty, RFKT_FLEXProtocol, Protocol;

@interface RFKT_FLEXProtocolBuilder : NSObject
...
- (void)addProperty:(RFKT_FLEXProperty *)property isRequired:(BOOL)isRequired;
/// Adds a property to a protocol.
...
- (RFKT_FLEXProtocol *)registerProtocol;
