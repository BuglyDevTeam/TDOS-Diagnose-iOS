...
@interface RFKTToastBackgroundView : UIView
...
/**
 * 如果不设置磨砂，则styleColor直接作为`RFKTToastBackgroundView`的backgroundColor；如果需要磨砂，
 * 则会新增加一个`UIVisualEffectView`放在`RFKTToastBackgroundView`上面。
 */
