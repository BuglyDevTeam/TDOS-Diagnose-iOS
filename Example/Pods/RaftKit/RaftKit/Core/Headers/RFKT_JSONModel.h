 ...
 */
@protocol RFKT_AbstractJSONModelProtocol <NSCopying, NSCoding>
 ...
 */
@interface RFKT_JSONModel : NSObject <RFKT_AbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(RFKT_JSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(RFKT_JSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(RFKT_JSONModelError **)err;
