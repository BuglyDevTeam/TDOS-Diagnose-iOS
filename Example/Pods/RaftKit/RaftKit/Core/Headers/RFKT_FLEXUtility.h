...
@interface RFKT_FLEXUtility : NSObject

/// The key window of the app, if it is not a \c RFKTWindow.
/// If it is, then \c RFKTWindow.previousKeyWindow is returned.
...
+ (NSString *)descriptionWithDetailsForView:(UIView *)view;
