...
@protocol RFKTEmptyViewLoadingViewProtocol <NSObject>
 ...
 */
@interface RFKTEmptyView : UIView

// 布局顺序从上到下依次为：imageView, loadingView, textLabel, detailTextLabel, actionButton

/// 此控件通过设置 loadingView.hidden 来控制 loadinView 的显示和隐藏，
/// 因此请确保你的loadingView 没有类似于 hidesWhenStopped = YES 之类会使 view.hidden 失效的属性
@property(nonatomic, strong) UIView<RFKTEmptyViewLoadingViewProtocol> *loadingView;
...
/**
 *  如果要继承RFKTEmptyView并添加新的子 view，则必须：
