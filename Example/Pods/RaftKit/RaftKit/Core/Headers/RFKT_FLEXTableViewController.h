...
@class RFKT_FLEXScopeCarousel, RFKTWindow, RFKT_FLEXTableViewSection;

typedef CGFloat RFKT_FLEXDebounceInterval;
/// No delay, all events delivered
extern CGFloat const kRFKT_FLEXDebounceInstant;
/// Small delay which makes UI seem smoother by avoiding rapid events
extern CGFloat const kRFKT_FLEXDebounceFast;
/// Slower than Fast, faster than ExpensiveIO
extern CGFloat const kRFKT_FLEXDebounceForAsyncSearch;
/// The least frequent, at just over once per second; for I/O or other expensive operations
extern CGFloat const kRFKT_FLEXDebounceForExpensiveIO;

@protocol RFKT_FLEXSearchResultsUpdating <NSObject>
...
@interface RFKT_FLEXTableViewController : UITableViewController <
...
@property (nonatomic) RFKT_FLEXTableView *tableView;

/// If your subclass conforms to \c RFKT_FLEXSearchResultsUpdating
...
@property (nonatomic, weak) id<RFKT_FLEXSearchResultsUpdating> searchDelegate;
...
@property (nonatomic) RFKT_FLEXScopeCarousel *carousel;
...
@property (nonatomic) RFKT_FLEXDebounceInterval searchBarDebounceInterval;
...
@property (nonatomic, weak) id<RFKT_FLEXSearchResultsUpdating> searchResultsUpdater;

/// self.view.window as a \c RFKTWindow
@property (nonatomic, readonly) RFKTWindow *window;
