...
@interface RFKT_FLEXResources : NSObject

#pragma mark - RFKT_FLEX Toolbar Icons
...
@property (readonly, class) UIImage *detailIcon;
@property (readonly, class) UIImage *layoutIcon;
