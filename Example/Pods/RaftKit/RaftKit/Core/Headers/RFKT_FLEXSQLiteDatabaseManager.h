...
@interface RFKT_FLEXSQLiteDatabaseManager : NSObject <RFKT_FLEXDatabaseManager>

/// Contains the result of the last operation, which may be an error
@property (nonatomic, readonly) RFKT_FLEXSQLResult *lastResult;
...
- (RFKT_FLEXSQLResult *)executeStatement:(NSString *)statement arguments:(NSDictionary<NSString *, id> *)args;
