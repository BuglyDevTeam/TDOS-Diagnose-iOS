...
@class RFKT_FLEXExplorerToolbarItem;

NS_ASSUME_NONNULL_BEGIN

/// Users of the toolbar can configure the enabled state
/// and event target/actions for each item.
@interface RFKT_FLEXExplorerToolbar : UIView

/// The items to be displayed in the toolbar. Defaults to:
/// globalsItem, hierarchyItem, selectItem, moveItem, closeItem
@property (nonatomic, copy) NSArray<RFKT_FLEXExplorerToolbarItem *> *toolbarItems;

/// Toolbar item for selecting views.
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *selectItem;

/// Toolbar item for presenting a list with the view hierarchy.
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *hierarchyItem;

/// Toolbar item for moving views.
/// Its \c sibling is the \c lastTabItem
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *moveItem;

/// Toolbar item for view's detail.
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *detailItem;

/// Toolbar item for show views' relative distance.
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *distanceItem;

/// Toolbar item for presenting the currently active tab.
//@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *recentItem;

/// Toolbar item for presenting a screen with various tools for inspecting the app.
//@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *globalsItem;

/// Toolbar item for hiding the explorer.
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *closeItem;
