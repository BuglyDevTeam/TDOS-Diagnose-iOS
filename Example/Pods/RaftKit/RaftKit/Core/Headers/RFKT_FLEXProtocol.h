...
@class RFKT_FLEXProperty, RFKT_FLEXMethodDescription;

#pragma mark RFKT_FLEXProtocol
@interface RFKT_FLEXProtocol : NSObject

/// Every protocol registered with the runtime.
+ (NSArray<RFKT_FLEXProtocol *> *)allProtocols;
...
@property (nonatomic, readonly) NSArray<RFKT_FLEXMethodDescription *>  *requiredMethods;
/// The optional methods of the protocol, if any. This includes property getters and setters.
@property (nonatomic, readonly) NSArray<RFKT_FLEXMethodDescription *>  *optionalMethods;
...
@property (nonatomic, readonly) NSArray<RFKT_FLEXProperty *>  *properties API_DEPRECATED("Use the more specific accessors below", ios(2.0, 10.0));

/// The required properties in the protocol, if any.
@property (nonatomic, readonly) NSArray<RFKT_FLEXProperty *>  *requiredProperties API_AVAILABLE(ios(10.0));
/// The optional properties in the protocol, if any.
@property (nonatomic, readonly) NSArray<RFKT_FLEXProperty *>  *optionalProperties API_AVAILABLE(ios(10.0));

/// For internal use
@property (nonatomic) id tag;

/// Not to be confused with \c -conformsToProtocol:, which refers to the current
/// \c RFKT_FLEXProtocol instance and not the underlying \c Protocol object.
...
@interface RFKT_FLEXMethodDescription : NSObject
...
@property (nonatomic, readonly) RFKT_FLEXTypeEncoding returnType;
