...
@interface RFKT_FLEXMethodBase : NSObject {
@protected
    SEL      _selector;
    NSString *_name;
    ...
    NSString *_rfkt_flex_description;
}

/// Constructs and returns an \c RFKT_FLEXSimpleMethod instance with the given name, type encoding, and implementation.
