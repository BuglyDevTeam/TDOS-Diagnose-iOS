...
@interface RFKT_FLEXExplorerToolbarItem : UIButton
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(nullable RFKT_FLEXExplorerToolbarItem *)backupItem;
...
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *sibling;
...
@property (nonatomic, readonly) RFKT_FLEXExplorerToolbarItem *currentItem;
