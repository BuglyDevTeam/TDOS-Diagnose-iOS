...
#define _RFKT_FLEXObjectExplorerViewController_h
#endif

#import "RFKT_FLEXFilteringTableViewController.h"
#import "RFKT_FLEXObjectExplorer.h"
@class RFKT_FLEXTableViewSection;

NS_ASSUME_NONNULL_BEGIN

/// A class that displays information about an object or class.
///
/// The explorer view controller uses \c RFKT_FLEXObjectExplorer to provide a description
...
@interface RFKT_FLEXObjectExplorerViewController : RFKT_FLEXFilteringTableViewController

/// Uses the default \c RFKT_FLEXShortcutsSection for this object as a custom section.
+ (instancetype)exploringObject:(id)objectOrClass;
/// No custom section unless you provide one.
+ (instancetype)exploringObject:(id)objectOrClass customSection:(nullable RFKT_FLEXTableViewSection *)customSection;
...
@property (nonatomic, readonly) RFKT_FLEXObjectExplorer *explorer;
