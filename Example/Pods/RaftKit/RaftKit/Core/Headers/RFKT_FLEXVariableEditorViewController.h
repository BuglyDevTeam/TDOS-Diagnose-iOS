...
@class RFKT_FLEXFieldEditorView;
@class RFKT_FLEXArgumentInputView;
...
@interface RFKT_FLEXVariableEditorViewController : UIViewController {
    @protected
    id _target;
    _Nullable id _data;
...
@property (nonatomic, readonly, nullable) RFKT_FLEXArgumentInputView *firstInputView;

@property (nonatomic, readonly) RFKT_FLEXFieldEditorView *fieldEditorView;
