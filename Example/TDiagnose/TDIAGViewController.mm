...
@implementation TDIAGViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    TDIAGAppDelegate *appDelegate = (TDIAGAppDelegate *)([UIApplication sharedApplication].delegate);
