...
Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/BuglyDevTeam/TDOS-Diagnose-iOS'
  spec.license          = { :type => 'MIT', :file => 'LICENSE' }
  spec.author           = { "Tencent" => "bugly@tencent.com" }
  spec.source           = { :git => 'https://github.com/BuglyDevTeam/TDOS-Diagnose-iOS.git', :tag => spec.version.to_s }
